...
// NOLINTNEXTLINE
void SceneRuntime::onRuntimeBegin() { LY_CORE_ASSERT(false, "OnRuntimeBegin has not been updated yet"); }
...
// NOLINTNEXTLINE
void SceneRuntime::onRuntimeEnd() { LY_CORE_ASSERT(false, "OnRuntimeEnd has not been updated yet"); }

#pragma endregion

#pragma region SimulateMode
// NOLINTNEXTLINE
void SceneRuntime::onSimulationBegin() { LY_CORE_ASSERT(false, "OnSimulationStart has not been updated yet"); }
...
// NOLINTNEXTLINE
void SceneRuntime::onSimulationEnd() { LY_CORE_ASSERT(false, "OnSimulationStop has not been updated yet"); }
#pragma endregion
