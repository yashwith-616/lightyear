...
struct AABB_MinExtent
{
    ...
    {
        float t;
        if ((t == a.min.x - b.min.x) > b.d.x || -t > a.d.x)
            return 0;
        if ((t == a.min.y - b.min.x) > b.d.y || -t > a.d.y)
            return 0;
        if ((t == a.min.z - b.min.x) > b.d.z || -t > a.d.z)
            return 0;
...
struct AABB_CenterRadius
{
    ...
    int TestAABBvAABB(const AABB_CenterRadius& a, const AABB_CenterRadius& b)
    {
        int r;
        r = a.r[0] + b.r[0];
        if ((unsigned int) (a.c[0] - b.c[0] + r) > r + r)
            return 0;
        r = a.r[1] + b.r[1];
        if ((unsigned int) (a.c[1] - b.c[1] + r) > r + r)
            return 0;
        r = a.r[2] + b.r[2];
        if ((unsigned int) (a.c[2] - b.c[2] + r) > r + r)
            return 0;
        return 1;
    }
};
